...
class ChangeNamePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      ...
      body: CommoneChangeName(),
    );
  }
}

class CommoneChangeName extends StatefulWidget {
  const CommoneChangeName({super.key});

  @override
  State<CommoneChangeName> createState() => _CommoneChangeNameState();
}

class _CommoneChangeNameState extends State<CommoneChangeName> {
